...
- (void)viewDidLoad {
    ...
    _contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 80, self.view.bounds.size.width, 100)];
    _contentLabel.numberOfLines = 0;
    _contentLabel.textAlignment = NSTextAlignmentCenter;
    _contentLabel.backgroundColor = kRandomColor;
    _contentLabel.text = @"第 2 页";
    [self.view addSubview:_contentLabel];
    
    NSLog(@"viewDidLoad 第 2 页");
}

- (void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    NSLog(@"viewWillAppear 第 2 页");
}

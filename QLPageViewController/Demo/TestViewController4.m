...
- (void)viewDidLoad {
    ...
    _contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 140, self.view.bounds.size.width, 100)];
    _contentLabel.numberOfLines = 0;
    _contentLabel.textAlignment = NSTextAlignmentCenter;
    _contentLabel.backgroundColor = kRandomColor;
    _contentLabel.text = @"第 4 页";
    [self.view addSubview:_contentLabel];
    
    NSLog(@"viewDidLoad 第 4 页");
}

- (void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    NSLog(@"viewWillAppear 第 4 页");
}
